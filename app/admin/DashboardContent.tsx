            ...
            <div className="flex items-center space-x-4 mb-6">
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-2 mt-2">
                  ...
                  >
                    {Math.abs(percentageChange.incomeToday)}% compared to
                    yesterday
                  </p>
                </div>
              </div>
              ...
              <div className="w-1/3 bg-gray-200 rounded-full h-2.5">
                <div
                  ...
                  style={{
                    width: `${Math.abs(percentageChange.incomeToday)}%`,
                  }}
                ></div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4 mb-6">
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-2 mt-2">
                  ...
                  >
                    {Math.abs(percentageChange.incomeWeekly)}% compared to last
                    week
                  </p>
                </div>
              </div>
              ...
              <div className="w-1/3 bg-gray-200 rounded-full h-2.5">
                <div
                  className="bg-blue-600 h-2.5 rounded-full"
                  style={{
                    width: `${Math.abs(percentageChange.incomeWeekly)}%`,
                  }}
                ></div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-2 mt-2">
                  ...
                  >
                    {Math.abs(percentageChange.incomeMonthly)}% compared to last
                    month
                  </p>
                </div>
              </div>
              ...
              <div className="w-1/3 bg-gray-200 rounded-full h-2.5">
                <div
                  className="bg-blue-600 h-2.5 rounded-full"
                  style={{
                    width: `${Math.abs(percentageChange.incomeMonthly)}%`,
                  }}
                ></div>
              </div>
            </div>
