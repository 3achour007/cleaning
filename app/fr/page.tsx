      ...
      <main className="flex-1 w-full text-center">
        ...
        <section className="py-16 max-w-5xl mx-auto">
          ...
          <p className="text-lg mb-8">
            Des services de nettoyage professionnels et abordables adaptés à
            votre domicile ou bureau à {userCity}. Nous employons exclusivement
            des produits de nettoyage biosourcés afin de préserver un
        ...
        <section id="services" className="py-16 max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="p-6 bg-white rounded-lg shadow text-center">
              ...
              <p>
                Gardez votre espace de travail propre, organisé et professionnel
                avec nos services de nettoyage de bureau experts.
              </p>
            </div>
            ...
            <div className="p-6 bg-white rounded-lg shadow text-center">
              ...
              <p>
                Transformez votre garage en un espace propre et fonctionnel avec
                nos solutions de nettoyage de garage approfondies.
              </p>
            </div>
            ...
            <div className="p-6 bg-white rounded-lg shadow text-center">
              ...
              <p>
                Assurez-vous que les espaces partagés comme les halls, les
                couloirs et les escaliers sont impeccables et accueillants.
              </p>
            </div>
            ...
            <div className="p-6 bg-white rounded-lg shadow text-center">
              ...
              <p>
                Profitez d'un domicile propre et confortable avec nos services
                de nettoyage résidentiel sur mesure.
              </p>
            </div>
          </div>
        </section>
        ...
        >
          <div className="px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-lg sm:text-xl text-gray-700 space-y-8 text-left mx-auto w-full sm:w-3/4 lg:w-1/2 px-4 sm:px-0">
              <p>
                Nous sommes plus qu'une entreprise de nettoyage chez{' '}
                <strong className="text-blue-600">Eco Friendly Cleaning</strong>
                , nous sommes vos partenaires pour améliorer la propreté, la
                santé et la durabilité de l'environnement. Grâce à notre
                expérience de plusieurs années dans le domaine, nous avons
                développé une réputation en offrant des{' '}
                <strong>solutions de nettoyage de qualité supérieure</strong>{' '}
                qui répondent aux besoins spécifiques des foyers et des
                entreprises.
              </p>
              <p>
                Notre point de distinction réside dans notre dévouement à
                l'utilisation de produits de nettoyage entièrement biosourcés. À
                la différence des produits chimiques classiques, nos solutions
                respectueuses de l'environnement sont provenant d'ingrédients
                naturels qui garantissent la sécurité de votre famille, de vos
                animaux de compagnie et de la planète. Il est essentiel de
                sélectionner des produits biologiques :
              </p>
              <ul className="list-disc list-inside space-y-4 pl-6">
                <li>
                  <strong>Sécurité pour votre bien-être :</strong> Nos produits
                  biologiques ne contiennent aucun produit chimique agressif,
                  toxine ou allergène, assurant ainsi un environnement sécurisé
                  et sain pour tous.
                </li>
                <li>
                  <strong>Environnementales :</strong> En employant des
                  composants biodégradables et durables, nous diminuons notre
                  impact sur l'environnement et participons à un avenir plus
                  respectueux de l'environnement.
                </li>
                <li>
                  <strong>La performance de nettoyage est :</strong>{' '}
                  N'abandonnez pas le terme "naturel" - nos produits biologiques
                  sont extrêmement efficaces pour éliminer la saleté, la crasse
                  et les taches, rendant votre espace impeccable.
                </li>
                <li>
                  <strong>Très doux sur les surfaces :</strong> Nos articles
                  sont élaborés pour effectuer un nettoyage approfondi sans
                  causer de dommages à vos meubles, sols ou appareils.
                </li>
              </ul>
              <p>
                Que vous souhaitiez effectuer un nettoyage en profondeur
                occasionnel ou effectuer un entretien régulier, notre équipe de{' '}
                <strong>professionnels qualifiés</strong> est disponible pour
                vous offrir un service exceptionnel avec une touche personnelle.
                Notre attention aux détails, notre fiabilité et notre dévouement
                à la satisfaction des clients nous font être fiers.
              </p>
              <p>
                Venez nous rejoindre afin de contribuer positivement à
                l'environnement tout en bénéficiant d'un environnement plus
                propre et plus sain.{' '}
                <strong className="text-blue-600">
                  Sélectionnez le service de nettoyage écologique
                </strong>{' '}
                - où la propreté se marie avec la durabilité.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="p-6 bg-white rounded-lg shadow text-center">
                ...
                <p>
                  Avec près d'une décennie d'expérience, nous avons maîtrisé
                  l'art de fournir des services de nettoyage exceptionnels
              ...
              <div className="p-6 bg-white rounded-lg shadow text-center">
                <img
                  ...
                  className="w-full h-48 object-cover mb-4 sm:w-48 sm:h-32"
                />
                <h3 className="text-xl font-semibold mb-2">Qualité Inégalée</h3>
                <p>
                  Notre fierté réside dans notre capacité à proposer des
                  services de nettoyage de qualité supérieure qui surpassent les
                  attentes, assurant ainsi que votre espace reste impeccable à
                  tout moment.
                </p>
              </div>
              ...
              <div className="p-6 bg-white rounded-lg shadow text-center">
                ...
                <p>
                  Votre satisfaction est notre priorité. Nous écoutons
                  attentivement vos besoins et fournissons des solutions
                  personnalisées qui vous conviennent.
                </p>
              </div>
              ...
              <div className="p-6 bg-white rounded-lg shadow text-center">
                ...
                <p>
                  De la maison aux bureaux et plus encore, nous proposons une
                  variété de services de nettoyage pour satisfaire toutes les
                  exigences.
                </p>
              </div>
            </div>
        ...
        <section id="contact" className="py-16 max-w-5xl mx-auto">
          ...
          <p className="mb-4">
            Pour des questions ou pour réserver nos services, veuillez nous
            appeler ou nous envoyer un email.
          </p>
          <p>
      ...
      <footer className="w-full py-12 bg-gray-800 text-gray-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center">
            <p className="text-gray-300">
              &copy; {new Date().getFullYear()} Eco Friendly Cleaning. Tous
              droits réservés.
            </p>
